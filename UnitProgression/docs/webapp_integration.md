...
- Per Level Variant selection + keeper lock
- On keeper lock run denoise + composite via job queue
- Fullscreen image viewer of Variants, navigate through variants with arrow keys
