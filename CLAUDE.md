...
| **Unit progressions** (`UnitProgression/`) | 10-level rank-progression PNG ramps (L1 → L10) for army units (Archer, Infantry, Cavalry, …) | fal-ai/nano-banana-pro/edit (image edit) → fal-ai/nafnet/deblur → composite-keeper skill | [`/unit-progression`](.claude/skills/unit-progression/SKILL.md) | Skill / CLI driven (no webapp UI) |
